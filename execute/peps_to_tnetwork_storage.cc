...
int main()
{
    ...
    ss.str("");
    ss << "/home/jiangsb/tn_ying/tensor_network/result/tnetwork_storage/kagome_simple_update/kagome_rvb_normal_D=" << D << "_Lx=" << Lx << "_Ly=" << Ly << "_mu12=" << kagome_psg::mu_12 << "_muc6=" << kagome_psg::mu_c6 << "_step=1e-2";
    file_name=ss.str();
