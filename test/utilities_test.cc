...
int main()
{
    ...
    std::stringstream ss;
    //zero-flux state
    ss << "/home/jiangsb/code/peps_itensor/result/peps_storage/optimized_peps/square_rvb_D=6_Lx=8_Ly=8_patch=2x2_optimized_step_1e-4"; 
    //pi-flux state
    ...
    //zero-flux state
    ss_tnetwork << "/home/jiangsb/code/peps_itensor/result/tnetwork_storage/square_rvb_D=6_Lx=8_Ly=8_patch=2x2_optimized_1e-4";
    //pi-flux state
